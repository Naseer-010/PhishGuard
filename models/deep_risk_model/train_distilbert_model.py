"""Train a DistilBERT text classifier for the deep phishing model."""
...
MODEL_DIR = ARTIFACT_DIR / "deep_distilbert"
METRICS_PATH = ARTIFACT_DIR / "deep_distilbert_metrics.json"


def main() -> None:
    parser = argparse.ArgumentParser(description="Train the deep DistilBERT phishing text model")
