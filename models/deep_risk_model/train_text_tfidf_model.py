"""Train a TF-IDF text classifier for the deep phishing model."""
...
TEXT_MODEL_PATH = ARTIFACT_DIR / "deep_tfidf_text.joblib"
TEXT_METRICS_PATH = ARTIFACT_DIR / "deep_tfidf_text_metrics.json"


def main() -> None:
    parser = argparse.ArgumentParser(description="Train the deep TF-IDF phishing text model")
    ...
    parser.add_argument("--max-features", type=int, default=40000, help="Maximum TF-IDF vocabulary size")
