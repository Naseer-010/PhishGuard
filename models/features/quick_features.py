...
def build_quick_feature_dict(url: str, page: PageAnalysis) -> dict[str, float | int]:
    ...
    features: dict[str, float | int] = {
        ...
        "redirect_chain_domain_changes": page.redirect_chain_domain_changes,
        "redirect_chain_suspicious": int(page.redirect_chain_suspicious),
        ...
        "has_payment_form": int(page.has_payment_form),
        "favicon_host_mismatch": int(page.favicon_host_mismatch),
        "brand_match_count": page.brand_match_count,
        "brand_impersonation_detected": int(page.brand_impersonation_detected),
